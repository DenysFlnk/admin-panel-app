...
public class GetCountTest extends AbstractTest {
    ...
    public void getCountWithoutFiltersReturnAllPlayers() throws Exception {
        ...
        assertSame("Returning incorrect result when querying GET /rest/players/count.", expected, actual);
    }
    ...
    public void getCountWithFiltersMinLevelMinExperience() throws Exception {
        ...
        assertSame("Returning incorrect result when querying GET /rest/players/count with parameters minLevel and minExperience.", expected, actual);
    }
    ...
    public void getCountWithFiltersNameAfterMaxLevel() throws Exception {
        ...
        assertSame("Returning incorrect result when querying GET /rest/players/count with parameters name, after and maxLevel.", expected, actual);
    }
    ...
    public void getCountWithFiltersRaceProfessionBanned() throws Exception {
        ...
        assertSame("Returning incorrect result when querying GET rest/players/count with parameters race, profession and banned.", expected, actual);
    }
    ...
    public void getCountWithFiltersRaceProfessionMaxExperience() throws Exception {
        ...
        assertSame("Returning incorrect result when querying GET /rest/players/count with parameters race, profession and maxExperience.", expected, actual);
    }
    ...
    public void getCountWithFiltersTitle() throws Exception {
        ...
        assertSame("Returning incorrect result when querying GET /rest/players/count with parameter title.", expected, actual);
    }
    ...
    public void getCountWithFiltersRaceProfessionBefore() throws Exception {
        ...
        assertSame("Returning incorrect result when querying GET /rest/players/count with parameters race, profession and before.", expected, actual);
    }
    ...
    public void getCountWithFiltersBanned() throws Exception {
        ...
        assertSame("Returning incorrect result when querying GET /rest/players/count with parameter banned.", expected, actual);
    }
}