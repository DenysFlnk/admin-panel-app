...
public class UpdatePlayerTest extends AbstractTest {
    ...
    public void updatePlayerWithIdTest() throws Exception {
        ...
        assertNotEquals("In request POST /rest/players/{id} field id can not be changed.", 8, actual.id);
        assertEquals("In request POST /rest/players/{id} with id in request body, everything must be updated except id", expected, actual);
    }
    ...
    public void updatePlayerEmptyBodyTest() throws Exception {
        ...
        assertEquals("In request POST /rest/players/{id} with empty request body, player can not be changed", expected, actual);
    }
    ...
    public void updatePlayerLevelTest() throws Exception {
        ...
        assertEquals("In request POST /rest/players/{id} with level in request body, everything must be updated except level", expected, actual);
    }
    ...
    public void updatePlayerWithDataTest1() throws Exception {
        ...
        assertEquals("In request POST /rest/players/{id} player should be updated, but experience and untilNextLevel must be recalculated", expected, actual);
    }
