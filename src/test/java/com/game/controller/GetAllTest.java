...
public class GetAllTest extends AbstractTest {
    ...
    public void getAllWithoutFiltersReturnAllPlayers() throws Exception {
        ...
        assertEquals("Returning incorrect result when querying GET /rest/players.", expected, actual);
    }
    ...
    public void getAllWithFiltersNamePageNumber() throws Exception {
        ...
        assertEquals("Returning incorrect result when querying GET /rest/players with parameters name and pageNumber.", expected, actual);
    }
    ...
    public void getAllWithFiltersTitlePageSize() throws Exception {
        ...
        assertEquals("Returning incorrect result when querying GET /rest/players with parameters title and pageSize.", expected, actual);
    }
    ...
    public void getAllWithFiltersRaceProfessionAfterBefore() throws Exception {
        ...
        assertEquals("Returning incorrect result when querying GET /rest/players with parameters race, profession, after and before.", expected, actual);
    }
    ...
    public void getAllWithFiltersRaceProfessionMinExperienceMaxExperience() throws Exception {
        ...
        assertEquals("Returning incorrect result when querying GET /rest/players with parameters race, minExperience and maxExperience.", expected, actual);
    }
    ...
    public void getAllWithFiltersBannedMinLevelMaxLevel() throws Exception {
        ...
        assertEquals("Returning incorrect result when querying GET /rest/players with parameters banned, minLevel and maxLevel.", expected, actual);
    }
    ...
    public void getAllWithFiltersBannedMaxLevel() throws Exception {
        ...
        assertEquals("Returning incorrect result when querying GET /rest/players with parameters banned and maxLevel.", expected, actual);
    }
    ...
    public void getAllWithFiltersAfterBeforeMinExperienceMaxExperience() throws Exception {
        ...
        assertEquals("Returning incorrect result when querying GET /rest/players with parameters after, before, minExperience and maxExperience.", expected, actual);
    }
}