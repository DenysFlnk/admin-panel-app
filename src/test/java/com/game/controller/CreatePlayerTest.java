...
public class CreatePlayerTest extends AbstractTest {
    ...
    public void createPlayerTest() throws Exception {
        ...
        PlayerInfoTest expected = new PlayerInfoTest(41L, "Amarylis", "Proselyte", Race.DWARF, Profession.CLERIC, 988059600000L, true, 63986, 35, 2614);
        String contentAsString = resultActions.andReturn().getResponse().getContentAsString();
        PlayerInfoTest actual = new ObjectMapper().readValue(contentAsString, PlayerInfoTest.class);
        assertEquals("An incorrect result is returned when requesting to create a player.", expected, actual);
    }
}